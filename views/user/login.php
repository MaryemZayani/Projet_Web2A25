...
<head>
    ...
    <body>
        ...
        <div class="footer">
            Don't have an account? <a href="../../views/user/register.php">Sign up</a>
        </div>
    </div>
    
    <!-- Debug output - hidden by default, can be toggled -->
    <div class="debug-container" style="display: none;">
        <div class="debug-title">Session Data (Debug)</div>
        <pre><?= print_r($_SESSION, true) ?></pre>
    </div>
    
    <script>
        // Simple script to toggle debug info (optional)
